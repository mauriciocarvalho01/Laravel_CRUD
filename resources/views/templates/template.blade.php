        ...
        <div class="container-fluid">
          <nav class="float-left">
            <ul>
              ...
              <li>
                <a href="https://github.com/mauriciocarvalho01?tab=repositories">
          ...
          <div class="copyright float-right">
            ...
            <a href="https://www.creative-tim.com" target="_blank">Mauricio Carvalho</a> para Commodity.
          </div>
        </div>
      </footer>
    </div>
...
<!-- <script src="{{url('assets/js/scripts/scripts.js')}}"></script> -->
